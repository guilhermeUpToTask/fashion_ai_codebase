                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
                            ...
                            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 border border-gray-200 shadow-lg">
                                ...
                                <p className="text-[#6B7280] mb-4">
                                    Upload product images to be automatically
                                    processed by AI. The system detects clothing
                                    items, generates semantic labels, and stores
                                    them in a vector database for similarity
                                    search.
                                </p>
                                <Button
                                    size="lg"
                            ...
                            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 border border-gray-200 shadow-lg">
                                ...
                                <p className="text-[#6B7280] mb-4">
                                    Upload any image containing clothing to find
                                    visually similar products from your indexed
                                    catalog using AI-powered similarity search.
                                </p>
                                <Button
                                    variant="outline"
                                    size="lg"
