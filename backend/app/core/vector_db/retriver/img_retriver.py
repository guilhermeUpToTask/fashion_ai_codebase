...
# #retriver is responsable for mounting the query and using metadata
# #we will change this to work with a list of float
# def retrive_most_similar_img(img_vector: List[float], label_vector, collection:Collection, session:Session) -> ImageDB | None:
