"""new schema of indexing and querying

Revision ID: c0dbfd876376
Revises: dc5b0a5c0c76
Create Date: 2025-08-06 16:58:06.701524
...
def upgrade() -> None:
    ...
    op.create_table('query_result_cloths',
    sa.Column('id', sa.Uuid(), nullable=False),
    sa.Column('query_result_id', sa.Uuid(), nullable=False),
    sa.Column('crop_img_id', sa.Uuid(), nullable=False),
    sa.ForeignKeyConstraint(['crop_img_id'], ['images.id'], ),
    sa.ForeignKeyConstraint(['query_result_id'], ['query_results.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('query_result_product_images',
    sa.Column('id', sa.Uuid(), nullable=False),
    sa.Column('cloth_id', sa.Uuid(), nullable=False),
    sa.Column('matched_image_id', sa.Uuid(), nullable=False),
    sa.Column('score', sa.Float(), nullable=False),
    sa.Column('rank', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['cloth_id'], ['query_result_cloths.id'], ),
    sa.ForeignKeyConstraint(['matched_image_id'], ['images.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('cloth_id', 'matched_image_id')
    )
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('query_result_product_images')
    op.drop_table('query_result_cloths')
